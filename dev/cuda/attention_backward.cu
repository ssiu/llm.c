...
//    int T_r = 64;
    ...
    dim3 dimBlock3(256);
    int maxbytes3 = 98304;
    cudaFuncSetAttribute(flash_attention_forward_kernel2, cudaFuncAttributeMaxDynamicSharedMemorySize, maxbytes3);
    flash_attention_forward_kernel2<<<dimGrid2, dimBlock2, maxbytes3>>>(out, inp, l, B, T, NH, HS);
